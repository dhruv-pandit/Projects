...
st.markdown("The world plot illustrates the source of travel demand for the selected destination (dark green), with countries ranked on a scale from 0 to 100; higher values (light orange) indicate stronger relative demand based on search activity.")
